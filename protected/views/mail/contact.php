                            ...
                            <tbody>
                                <tr style="margin:0;padding:0">
                                    <td style="margin:0;padding:0">
                                        ...
                                        <p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Berikut ini pesan yang anda kirimkan kepada kami.</p>
                                        <div style="margin:0 0 20px;padding:0">
                                            ...
                                            <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                <tbody style="margin:0;padding:0">
                                                    <tr style="margin:0;padding:0">
                                                        <td valign="top" style="width:25%;font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0">Subject:
                                                        </td>
                                                        <td valign="top" style="font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0"><?php echo $model->subject ?>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tr style="margin:0;padding:0">
                                    <td valign="top" style="margin:0;padding:0 10px 0 0;width:75%">
                                        ...
                                        <span style="font-size:12px;margin-bottom:6px;display:inline-block">
                                            <b>Hubungi <span class="lG">medisku.co.id</span></b> <br>
                                    ...
                                    <td valign="top" style="margin:0;padding:0">
                                        ...
                                        <div style="text-align:left">
                                            <?php if ($this->setting['url_facebook'] != ''): ?>
                                                <a target="_blank" style="color:#008000;display:inline-block" href="<?php echo $this->setting['url_facebook'] ?>"><img style="border:0;min-height:auto;max-width:100%;outline:0" alt="Facebook" src="<?php echo $baseUrl ?>/asset/images/icons/ic-facebook-hm.png"></a>
                                            <?php endif ?>
