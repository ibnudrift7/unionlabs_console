...
class PromotionsController extends ControllerAdmin
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Promotions']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("PromotionsController Create $model->id");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Promotions']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("PromotionsController Update $model->id");
