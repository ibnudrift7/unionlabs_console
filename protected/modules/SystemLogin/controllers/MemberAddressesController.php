...
class MemberAddressesController extends ControllerAdmin
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UserAddresses']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("MemberAddressesController Create $model->id");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['UserAddresses']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("MemberAddressesController Update $model->id");
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('UserAddresses');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-addresses-form')
		{
