...
<div class="card mt-3">
	<div class="card-body">
		...
		<div class="wrapped">
							...
							<?php echo $form->textFieldRow($model,'support_tracking',array('class'=>'span5')); ?>

							<?php echo $form->textFieldRow($model,'api_endpoint',array('class'=>'span5','maxlength'=>255)); ?>
