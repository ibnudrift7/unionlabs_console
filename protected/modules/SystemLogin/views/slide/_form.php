			...
			<div class="widgetcontent">
				...
				*/ ?>
				...
				<div class="row-fluid">
					...
					<div class="span6">
						<?php
						// echo $form->dropDownListRow($model, 'hide_teks', array(
						// 	'1' => 'Hide Teks',
						// 	'0' => 'View Teks',
						// ));
						?>
		...
		<div class="widgetbox block-rightcontent">
			...
			<div class="widgetcontent">
				<?php echo $form->fileFieldRow($model, 'image', array(
					'hint' => '<b>Note:</b> Image size is 1919 x 720px. Larger image will be automatically cropped.',
					'style' => "width: 100%"
				)); ?>
				<?php if ($model->scenario == 'update'): ?>
					<img style="width: 100%;" src="<?php echo Yii::app()->baseUrl . ImageHelper::thumb(1440, 683, '/images/slide/' . $model->image, array('method' => 'adaptiveResize', 'quality' => '90')) ?>" />
				<?php endif; ?>
			</div>
		</div>
		...
		<div class="widgetbox block-rightcontent">
			...
			<div class="widgetcontent">
				<?php echo $form->fileFieldRow($model, 'image2', array(
					'hint' => '<b>Note:</b> Image size is 774 x 867px. Larger image will be automatically cropped.',
					'style' => "width: 100%"
				)); ?>
				<?php if ($model->scenario == 'update'): ?>
