...
<main id="main" class="main mt-0" style="margin-top: 0px !important;">
    <div class="d-flex justify-content-between">
        <div class="pagetitle">
            <h1>Dashboard Opname Payment - <?php echo $data['title']; ?></h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo Yii::app()->createUrl('SystemLogin/site/index'); ?>">Home</a></li>
                    <li class="breadcrumb-item active">Dashboard Opname Payment - <?php echo $data['title']; ?></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
