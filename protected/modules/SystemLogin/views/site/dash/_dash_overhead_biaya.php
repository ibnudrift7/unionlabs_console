...
<main id="main" class="main mt-0" style="margin-top: 0px !important;">
    <div class="d-flex justify-content-between">
        <div class="pagetitle">
            <h1>Dashboard Overhead Biaya - <?php echo $data['title']; ?></h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo Yii::app()->createUrl('SystemLogin/site/index'); ?>">Home</a></li>
                    <li class="breadcrumb-item active">Dashboard PO - <?php echo $data['title']; ?></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <div class="right_info text-end text-right">
            <?php
            // get name proyek
            $project = Proyeks::model()->findByPk($_GET['projects']);
            ?>
            <span class="text-bold"><b>Proyek</b>: <?php echo $project->names; ?></span>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <table class="table table-striped custom_rekap">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Item Rekapan</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value->bank . ' - ' . $value->bank_rekening; ?></td>
                                                            <td><?php echo ($value->tgl_bayar) ? date('d-m-Y', strtotime($value->tgl_bayar)) : '-'; ?></td>
                                                            <td><?php echo $value->dibuat; ?></td>
                                                            <td><?php echo 'Rp ' . number_format($value->amount, 2, ',', '.'); ?></td>
                                                            <td><?php echo $value->mengetahui; ?></td>
                                                            <td><?php echo $value->ref_no; ?></td>
                                                            <!-- <td><?php echo date('d-m-Y', strtotime($value->tgl_input)); ?></td> -->
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                                <tfoot>
