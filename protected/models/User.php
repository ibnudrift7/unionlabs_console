 ...
 *
 * The followings are the available columns in table 'm_admin':
 * @property integer $id
...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tanggal_input, nama, image, company_id, role_id', 'safe'),
	...
	public function relations()
	{
		...
		return array(
			...
			'role' => array(self::BELONGS_TO, 'MAdminRoles', 'role_id'),
	...
	public function getUserAccess()
	{
		...
		$akses = array();
		if (is_array($data) && count($data) > 0 and $data !== '' and $data != false) {
