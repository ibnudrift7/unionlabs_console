...
/**
 * This is the model class for table "uni_product_categories".
 *
 * The followings are the available columns in table 'uni_product_categories':
 * @property string $id
