...
/**
 * This is the model class for table "bw_articles_category".
 *
 * The followings are the available columns in table 'bw_articles_category':
 * @property integer $id
